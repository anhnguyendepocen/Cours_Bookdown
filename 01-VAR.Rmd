...
```{r preMadeFigureICA, fig.align = 'left-aligned', out.width = "95%", fig.cap = "XXXX.", echo=FALSE}
knitr::include_graphics("images/Figure_A.png")
```


```{r preMadeFigureICA2, fig.align = 'left-aligned', out.width = "95%", fig.cap = "XXXX.", echo=FALSE}
library(AEC)
nb.sim <- 12
n <- 2
Phi <- array(NaN,c(n,n,1))
...
```{r preMadeFigureICAGaussianStudent, fig.align = 'left-aligned', out.width = "95%", fig.cap = "XXXX.", echo=FALSE}
...
```{r ThreePlots, fig.align = 'left-aligned', out.width = "95%", fig.cap = "XXXX.", echo=FALSE}
...
In the case where one suspects that the $y_{i,t}$'s are mainly driven by a small number of random sources, a factor structure may be imposed, and **principal component analysis** can be employed to estimate the relevant factors (@Bernanke_Boivin_Eliasz_2005).
...
```{r essaiIV, warning=FALSE,message=FALSE, fig.align = 'left-aligned', out.width = "95%", fig.cap = "Reponses to a monetary-policy shock, LP-IV approach."}
