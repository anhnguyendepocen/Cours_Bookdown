...
## Statistics: definitions and results {#variousResults}
...
An asymptotic test with critical region $\Omega_n$ has an \color{blue}{asymptotic level} equal to $\alpha$ if:
$$
...
```{r inverseMills, echo=FALSE, fig.cap="$\\mathbb{E}(X|X<b)$ as a function of $b$ when $X\\sim \\mathcal{N}(0,1)$ (in black).", fig.align = 'center'}
x <- seq(-10,10,by=.01)
par(mfrow=c(1,1))
...
### Proof of Proposition \@ref(prp:MLEproperties) {#MLEproperties}
...
### Proof of Proposition \@ref(prp:Walddistri) {#Walddistri}
...
### Proof of Proposition \@ref(prp:LMdistri) {#LMdistri}
...
### Proof of Proposition \@ref(prp:equivWaldLM) {#equivWaldLM}
...
### Proof of Proposition \@ref(prp:equivLRLM) {#equivLRLM}
...
### Proof of Eq. \@ref(eq:TCL2) {#proofTVTCL}
...
### Proof of Proposition \@ref(prp:smallestMSE) {#smallestMSE}
...
### Proof of Proposition \@ref(prp:estimVARGaussian) {#estimVARGaussian}
...
### Proof of Proposition \@ref(prp:OLSVAR) {#OLSVAR}
